...
_EL_DATED_SCHEDULE_RAW: list[tuple[int, str, str, str, str]] = [
    (1, "2026-09-16", "18:45", "Ararat-Armenia", "Sparta Prague"),
    (1, "2026-09-16", "18:45", "Omonia Nicosia", "Celta Vigo"),
    (1, "2026-09-16", "21:00", "AC Milan", "Benfica"),
    (1, "2026-09-16", "21:00", "Bayer Leverkusen", "Celje"),
    (1, "2026-09-16", "21:00", "Hapoel Beer Sheva", "Dinamo Zagreb"),
    (1, "2026-09-16", "21:00", "Olympiacos", "Jagiellonia"),
    (1, "2026-09-16", "21:00", "Anderlecht", "Lyon"),
    (1, "2026-09-16", "21:00", "Sturm Graz", "Rennes"),
    (1, "2026-09-16", "21:00", "Sunderland", "AZ Alkmaar"),
    (1, "2026-09-17", "18:45", "OFI", "TSG Hoffenheim"),
    (1, "2026-09-17", "18:45", "Levski Sofia", "Red Bull Salzburg"),
    (1, "2026-09-17", "21:00", "Beşiktaş", "Marseille"),
    (1, "2026-09-17", "21:00", "Celtic", "Ferencvarosi TC"),
    (1, "2026-09-17", "21:00", "Crystal Palace", "Lech Poznan"),
    (1, "2026-09-17", "21:00", "Plzen", "Union Saint-Gilloise"),
    (1, "2026-09-17", "21:00", "Juventus", "NEC Nijmegen"),
    (1, "2026-09-17", "21:00", "Lillestrom", "Torreense"),
    (1, "2026-09-17", "21:00", "Real Sociedad", "Bournemouth"),

    (2, "2026-10-15", "18:45", "Sparta Prague", "Lillestrom"),
    (2, "2026-10-15", "18:45", "AZ Alkmaar", "Hapoel Beer Sheva"),
    (2, "2026-10-15", "18:45", "Red Bull Salzburg", "AC Milan"),
    (2, "2026-10-15", "18:45", "Lech Poznan", "Bayer Leverkusen"),
    (2, "2026-10-15", "18:45", "Celje", "Omonia Nicosia"),
    (2, "2026-10-15", "18:45", "Lyon", "Crystal Palace"),
    (2, "2026-10-15", "18:45", "Union Saint-Gilloise", "Real Sociedad"),
    (2, "2026-10-15", "18:45", "Torreense", "Sunderland"),
    (2, "2026-10-15", "21:00", "Bournemouth", "Sturm Graz"),
    (2, "2026-10-15", "21:00", "Ferencvarosi TC", "Plzen"),
    (2, "2026-10-15", "21:00", "Dinamo Zagreb", "Anderlecht"),
    (2, "2026-10-15", "21:00", "Jagiellonia", "Ararat-Armenia"),
    (2, "2026-10-15", "21:00", "NEC Nijmegen", "Levski Sofia"),
    (2, "2026-10-15", "21:00", "Marseille", "Olympiacos"),
    (2, "2026-10-15", "21:00", "Celta Vigo", "Juventus"),
    (2, "2026-10-15", "21:00", "Benfica", "Celtic"),
    (2, "2026-10-15", "21:00", "Rennes", "OFI"),
    (2, "2026-10-15", "21:00", "TSG Hoffenheim", "Beşiktaş"),

    (3, "2026-10-22", "18:45", "Ararat-Armenia", "AZ Alkmaar"),
    (3, "2026-10-22", "18:45", "Ferencvarosi TC", "Torreense"),
    (3, "2026-10-22", "18:45", "Dinamo Zagreb", "NEC Nijmegen"),
    (3, "2026-10-22", "18:45", "Juventus", "Rennes"),
    (3, "2026-10-22", "18:45", "Lech Poznan", "Sunderland"),
    (3, "2026-10-22", "18:45", "OFI", "Bayer Leverkusen"),
    (3, "2026-10-22", "18:45", "Union Saint-Gilloise", "Hapoel Beer Sheva"),
    (3, "2026-10-22", "18:45", "Sturm Graz", "Marseille"),
    (3, "2026-10-22", "21:00", "Bournemouth", "AC Milan"),
    (3, "2026-10-22", "21:00", "Beşiktaş", "Crystal Palace"),
    (3, "2026-10-22", "21:00", "Celtic", "Celta Vigo"),
    (3, "2026-10-22", "21:00", "Plzen", "Levski Sofia"),
    (3, "2026-10-22", "21:00", "Jagiellonia", "Anderlecht"),
    (3, "2026-10-22", "21:00", "Lillestrom", "Real Sociedad"),
    (3, "2026-10-22", "21:00", "Celje", "Red Bull Salzburg"),
    (3, "2026-10-22", "21:00", "Olympiacos", "Sparta Prague"),
    (3, "2026-10-22", "21:00", "Omonia Nicosia", "Benfica"),
    (3, "2026-10-22", "21:00", "TSG Hoffenheim", "Lyon"),

    (4, "2026-11-05", "18:45", "AC Milan", "Ferencvarosi TC"),
    (4, "2026-11-05", "18:45", "Sparta Prague", "Bournemouth"),
    (4, "2026-11-05", "18:45", "Crystal Palace", "TSG Hoffenheim"),
    (4, "2026-11-05", "18:45", "Lillestrom", "Plzen"),
    (4, "2026-11-05", "18:45", "NEC Nijmegen", "Omonia Nicosia"),
    (4, "2026-11-05", "18:45", "Levski Sofia", "Jagiellonia"),
    (4, "2026-11-05", "18:45", "Real Sociedad", "Lyon"),
    (4, "2026-11-05", "18:45", "Anderlecht", "Red Bull Salzburg"),
    (4, "2026-11-05", "18:45", "Rennes", "Olympiacos"),
    (4, "2026-11-05", "21:00", "AZ Alkmaar", "Juventus"),
    (4, "2026-11-05", "21:00", "Bayer Leverkusen", "Marseille"),
    (4, "2026-11-05", "21:00", "Celtic", "Beşiktaş"),
    (4, "2026-11-05", "21:00", "Hapoel Beer Sheva", "OFI"),
    (4, "2026-11-05", "21:00", "Celta Vigo", "Union Saint-Gilloise"),
    (4, "2026-11-05", "21:00", "Torreense", "Ararat-Armenia"),
    (4, "2026-11-05", "21:00", "Sturm Graz", "Celje"),
    (4, "2026-11-05", "21:00", "Benfica", "Lech Poznan"),
    (4, "2026-11-05", "21:00", "Sunderland", "Dinamo Zagreb"),

    (5, "2026-11-26", "18:45", "Beşiktaş", "Hapoel Beer Sheva"),
    (5, "2026-11-26", "18:45", "Red Bull Salzburg", "Ararat-Armenia"),
    (5, "2026-11-26", "18:45", "Plzen", "Benfica"),
    (5, "2026-11-26", "18:45", "Dinamo Zagreb", "Bayer Leverkusen"),
    (5, "2026-11-26", "18:45", "Olympiacos", "AC Milan"),
    (5, "2026-11-26", "18:45", "Marseille", "Levski Sofia"),
    (5, "2026-11-26", "18:45", "Union Saint-Gilloise", "Lech Poznan"),
    (5, "2026-11-26", "18:45", "Celta Vigo", "Bournemouth"),
    (5, "2026-11-26", "21:00", "Sparta Prague", "AZ Alkmaar"),
    (5, "2026-11-26", "21:00", "Crystal Palace", "Real Sociedad"),
    (5, "2026-11-26", "21:00", "Ferencvarosi TC", "Celje"),
    (5, "2026-11-26", "21:00", "Juventus", "Omonia Nicosia"),
    (5, "2026-11-26", "21:00", "NEC Nijmegen", "Rennes"),
    (5, "2026-11-26", "21:00", "OFI", "Anderlecht"),
    (5, "2026-11-26", "21:00", "Lyon", "Lillestrom"),
    (5, "2026-11-26", "21:00", "Torreense", "Celtic"),
    (5, "2026-11-26", "21:00", "Sunderland", "Jagiellonia"),
    (5, "2026-11-26", "21:00", "TSG Hoffenheim", "Sturm Graz"),

    (6, "2026-12-10", "18:45", "AZ Alkmaar", "Sturm Graz"),
    (6, "2026-12-10", "18:45", "Ararat-Armenia", "NEC Nijmegen"),
    (6, "2026-12-10", "18:45", "Hapoel Beer Sheva", "Juventus"),
    (6, "2026-12-10", "18:45", "Jagiellonia", "Crystal Palace"),
    (6, "2026-12-10", "18:45", "Marseille", "Celta Vigo"),
    (6, "2026-12-10", "18:45", "Omonia Nicosia", "Celtic"),
    (6, "2026-12-10", "18:45", "Anderlecht", "TSG Hoffenheim"),
    (6, "2026-12-10", "18:45", "Rennes", "Dinamo Zagreb"),
    (6, "2026-12-10", "21:00", "AC Milan", "Sunderland"),
    (6, "2026-12-10", "21:00", "Bournemouth", "Plzen"),
    (6, "2026-12-10", "21:00", "Bayer Leverkusen", "Beşiktaş"),
    (6, "2026-12-10", "21:00", "Red Bull Salzburg", "Sparta Prague"),
    (6, "2026-12-10", "21:00", "Lech Poznan", "Ferencvarosi TC"),
    (6, "2026-12-10", "21:00", "Celje", "Olympiacos"),
    (6, "2026-12-10", "21:00", "Lyon", "Union Saint-Gilloise"),
    (6, "2026-12-10", "21:00", "Levski Sofia", "Lillestrom"),
    (6, "2026-12-10", "21:00", "Real Sociedad", "Torreense"),
    (6, "2026-12-10", "21:00", "Benfica", "OFI"),

    (7, "2027-01-21", "18:45", "Beşiktaş", "Union Saint-Gilloise"),
    (7, "2027-01-21", "18:45", "Ararat-Armenia", "Celje"),
    (7, "2027-01-21", "18:45", "Ferencvarosi TC", "Juventus"),
    (7, "2027-01-21", "18:45", "Jagiellonia", "Lyon"),
    (7, "2027-01-21", "18:45", "Lillestrom", "Bournemouth"),
    (7, "2027-01-21", "18:45", "NEC Nijmegen", "Benfica"),
    (7, "2027-01-21", "18:45", "Olympiacos", "TSG Hoffenheim"),
    (7, "2027-01-21", "18:45", "Real Sociedad", "Plzen"),
    (7, "2027-01-21", "18:45", "Sturm Graz", "OFI"),
    (7, "2027-01-21", "21:00", "AZ Alkmaar", "Dinamo Zagreb"),
    (7, "2027-01-21", "21:00", "Bayer Leverkusen", "Red Bull Salzburg"),
    (7, "2027-01-21", "21:00", "Celtic", "Marseille"),
    (7, "2027-01-21", "21:00", "Crystal Palace", "Sparta Prague"),
    (7, "2027-01-21", "21:00", "Hapoel Beer Sheva", "Celta Vigo"),
    (7, "2027-01-21", "21:00", "Lech Poznan", "Torreense"),
    (7, "2027-01-21", "21:00", "Levski Sofia", "AC Milan"),
    (7, "2027-01-21", "21:00", "Anderlecht", "Sunderland"),
    (7, "2027-01-21", "21:00", "Rennes", "Omonia Nicosia"),

    (8, "2027-01-28", "21:00", "AC Milan", "Ararat-Armenia"),
    (8, "2027-01-28", "21:00", "Sparta Prague", "Rennes"),
    (8, "2027-01-28", "21:00", "Bournemouth", "Hapoel Beer Sheva"),
    (8, "2027-01-28", "21:00", "Red Bull Salzburg", "Crystal Palace"),
    (8, "2027-01-28", "21:00", "Plzen", "Jagiellonia"),
    (8, "2027-01-28", "21:00", "Dinamo Zagreb", "Sturm Graz"),
    (8, "2027-01-28", "21:00", "Juventus", "Real Sociedad"),
    (8, "2027-01-28", "21:00", "Celje", "NEC Nijmegen"),
    (8, "2027-01-28", "21:00", "OFI", "Lech Poznan"),
    (8, "2027-01-28", "21:00", "Marseille", "Anderlecht"),
    (8, "2027-01-28", "21:00", "Lyon", "Bayer Leverkusen"),
    (8, "2027-01-28", "21:00", "Omonia Nicosia", "Beşiktaş"),
    (8, "2027-01-28", "21:00", "Union Saint-Gilloise", "Celtic"),
    (8, "2027-01-28", "21:00", "Celta Vigo", "Lillestrom"),
    (8, "2027-01-28", "21:00", "Torreense", "Olympiacos"),
    (8, "2027-01-28", "21:00", "Benfica", "AZ Alkmaar"),
    (8, "2027-01-28", "21:00", "Sunderland", "Levski Sofia"),
    (8, "2027-01-28", "21:00", "TSG Hoffenheim", "Ferencvarosi TC"),
]

_ECL_DATED_SCHEDULE_RAW: list[tuple[int, str, str, str, str]] = [
    (1, "2026-10-15", "18:45", "FC Lugano", "FK Crvena Zvezda"),
    (1, "2026-10-15", "18:45", "HNK Hajduk Split", "Ajax"),
    (1, "2026-10-15", "18:45", "Gent", "Aarhus"),
    (1, "2026-10-15", "18:45", "Egnatia Rrogozhinë", "FC Midtjylland"),
    (1, "2026-10-15", "18:45", "KuPS", "Trabzonspor"),
    (1, "2026-10-15", "18:45", "Mjallby AIF", "Inter Club d'Escaldes"),
    (1, "2026-10-15", "18:45", "Panathinaikos", "Borac Banja Luka"),
    (1, "2026-10-15", "18:45", "CSKA Sofia", "Monaco"),
    (1, "2026-10-15", "18:45", "Riga", "Kairat Almaty"),
    (1, "2026-10-15", "18:45", "Universitatea Craiova", "Getafe"),
    (1, "2026-10-15", "21:00", "Atalanta", "Pafos"),
    (1, "2026-10-15", "21:00", "Brighton", "Kauno Žalgiris"),
    (1, "2026-10-15", "21:00", "FC Copenhagen", "SC Braga"),
    (1, "2026-10-15", "21:00", "Twente", "FC Thun"),
    (1, "2026-10-15", "21:00", "Heart Of Midlothian", "FC Nordsjaelland"),
    (1, "2026-10-15", "21:00", "St. Truiden", "FC Iberia 1999"),
    (1, "2026-10-15", "21:00", "SC Freiburg", "FK Jablonec"),
    (1, "2026-10-15", "21:00", "Brann", "Lincoln Red Imps FC"),

    (2, "2026-10-22", "16:30", "Kairat Almaty", "Panathinaikos"),
    (2, "2026-10-22", "18:45", "FC Iberia 1999", "Mjallby AIF"),
    (2, "2026-10-22", "18:45", "FC Nordsjaelland", "CSKA Sofia"),
    (2, "2026-10-22", "18:45", "FK Crvena Zvezda", "FC Copenhagen"),
    (2, "2026-10-22", "18:45", "FK Jablonec", "Brighton"),
    (2, "2026-10-22", "18:45", "Kauno Žalgiris", "Brann"),
    (2, "2026-10-22", "18:45", "Getafe", "FC Lugano"),
    (2, "2026-10-22", "18:45", "Inter Club d'Escaldes", "Universitatea Craiova"),
    (2, "2026-10-22", "18:45", "Pafos", "Riga"),
    (2, "2026-10-22", "18:45", "Trabzonspor", "Heart Of Midlothian"),
    (2, "2026-10-22", "21:00", "Ajax", "Atalanta"),
    (2, "2026-10-22", "21:00", "Aarhus", "Egnatia Rrogozhinë"),
    (2, "2026-10-22", "21:00", "Monaco", "SC Freiburg"),
    (2, "2026-10-22", "21:00", "FC Midtjylland", "St. Truiden"),
    (2, "2026-10-22", "21:00", "FC Thun", "HNK Hajduk Split"),
    (2, "2026-10-22", "21:00", "Borac Banja Luka", "KuPS"),
    (2, "2026-10-22", "21:00", "Lincoln Red Imps FC", "Twente"),
    (2, "2026-10-22", "21:00", "SC Braga", "Gent"),

    (3, "2026-11-05", "18:45", "Aarhus", "SC Braga"),
    (3, "2026-11-05", "18:45", "Atalanta", "Kairat Almaty"),
    (3, "2026-11-05", "18:45", "FC Midtjylland", "Ajax"),
    (3, "2026-11-05", "18:45", "FC Thun", "Heart Of Midlothian"),
    (3, "2026-11-05", "18:45", "FK Crvena Zvezda", "Inter Club d'Escaldes"),
    (3, "2026-11-05", "18:45", "KuPS", "Gent"),
    (3, "2026-11-05", "18:45", "Lincoln Red Imps FC", "HNK Hajduk Split"),
    (3, "2026-11-05", "18:45", "Mjallby AIF", "Borac Banja Luka"),
    (3, "2026-11-05", "18:45", "Trabzonspor", "SC Freiburg"),
    (3, "2026-11-05", "21:00", "Monaco", "FC Nordsjaelland"),
    (3, "2026-11-05", "21:00", "FC Copenhagen", "FC Iberia 1999"),
    (3, "2026-11-05", "21:00", "FC Lugano", "Kauno Žalgiris"),
    (3, "2026-11-05", "21:00", "Twente", "Pafos"),
    (3, "2026-11-05", "21:00", "Getafe", "Brighton"),
    (3, "2026-11-05", "21:00", "St. Truiden", "Brann"),
    (3, "2026-11-05", "21:00", "Panathinaikos", "CSKA Sofia"),
    (3, "2026-11-05", "21:00", "Riga", "FK Jablonec"),
    (3, "2026-11-05", "21:00", "Universitatea Craiova", "Egnatia Rrogozhinë"),

    (4, "2026-11-26", "16:30", "Kairat Almaty", "Mjallby AIF"),
    (4, "2026-11-26", "18:45", "Ajax", "FC Thun"),
    (4, "2026-11-26", "18:45", "Brighton", "Universitatea Craiova"),
    (4, "2026-11-26", "18:45", "FC Iberia 1999", "Getafe"),
    (4, "2026-11-26", "18:45", "FK Jablonec", "FC Lugano"),
    (4, "2026-11-26", "18:45", "Kauno Žalgiris", "Riga"),
    (4, "2026-11-26", "18:45", "Heart Of Midlothian", "Monaco"),
    (4, "2026-11-26", "18:45", "Egnatia Rrogozhinë", "Lincoln Red Imps FC"),
    (4, "2026-11-26", "18:45", "Pafos", "FC Midtjylland"),
    (4, "2026-11-26", "18:45", "Brann", "Aarhus"),
    (4, "2026-11-26", "21:00", "FC Nordsjaelland", "Panathinaikos"),
    (4, "2026-11-26", "21:00", "Borac Banja Luka", "Atalanta"),
    (4, "2026-11-26", "21:00", "HNK Hajduk Split", "St. Truiden"),
    (4, "2026-11-26", "21:00", "Inter Club d'Escaldes", "FC Copenhagen"),
    (4, "2026-11-26", "21:00", "Gent", "FK Crvena Zvezda"),
    (4, "2026-11-26", "21:00", "CSKA Sofia", "Trabzonspor"),
    (4, "2026-11-26", "21:00", "SC Braga", "KuPS"),
    (4, "2026-11-26", "21:00", "SC Freiburg", "Twente"),

    (5, "2026-12-10", "16:30", "Kairat Almaty", "Universitatea Craiova"),
    (5, "2026-12-10", "18:45", "FC Copenhagen", "FC Lugano"),
    (5, "2026-12-10", "18:45", "FC Iberia 1999", "FK Crvena Zvezda"),
    (5, "2026-12-10", "18:45", "Getafe", "Inter Club d'Escaldes"),
    (5, "2026-12-10", "18:45", "KuPS", "CSKA Sofia"),
    (5, "2026-12-10", "18:45", "Lincoln Red Imps FC", "FC Midtjylland"),
    (5, "2026-12-10", "18:45", "Riga", "Atalanta"),
    (5, "2026-12-10", "18:45", "SC Freiburg", "Panathinaikos"),
    (5, "2026-12-10", "18:45", "Brann", "SC Braga"),
    (5, "2026-12-10", "18:45", "Trabzonspor", "FK Jablonec"),
    (5, "2026-12-10", "21:00", "Aarhus", "Twente"),
    (5, "2026-12-10", "21:00", "Brighton", "Monaco"),
    (5, "2026-12-10", "21:00", "FC Thun", "Gent"),
    (5, "2026-12-10", "21:00", "Heart Of Midlothian", "Borac Banja Luka"),
    (5, "2026-12-10", "21:00", "HNK Hajduk Split", "FC Nordsjaelland"),
    (5, "2026-12-10", "21:00", "St. Truiden", "Ajax"),
    (5, "2026-12-10", "21:00", "Egnatia Rrogozhinë", "Kauno Žalgiris"),
    (5, "2026-12-10", "21:00", "Mjallby AIF", "Pafos"),

    (6, "2026-12-17", "21:00", "Ajax", "Getafe"),
    (6, "2026-12-17", "21:00", "Monaco", "Lincoln Red Imps FC"),
    (6, "2026-12-17", "21:00", "Atalanta", "Mjallby AIF"),
    (6, "2026-12-17", "21:00", "FC Lugano", "St. Truiden"),
    (6, "2026-12-17", "21:00", "FC Midtjylland", "HNK Hajduk Split"),
    (6, "2026-12-17", "21:00", "FC Nordsjaelland", "KuPS"),
    (6, "2026-12-17", "21:00", "Twente", "Kairat Almaty"),
    (6, "2026-12-17", "21:00", "Borac Banja Luka", "Riga"),
    (6, "2026-12-17", "21:00", "FK Crvena Zvezda", "Trabzonspor"),
    (6, "2026-12-17", "21:00", "FK Jablonec", "FC Iberia 1999"),
    (6, "2026-12-17", "21:00", "Kauno Žalgiris", "SC Freiburg"),
    (6, "2026-12-17", "21:00", "Inter Club d'Escaldes", "Aarhus"),
    (6, "2026-12-17", "21:00", "Gent", "Brann"),
    (6, "2026-12-17", "21:00", "Pafos", "Heart Of Midlothian"),
    (6, "2026-12-17", "21:00", "Panathinaikos", "Brighton"),
    (6, "2026-12-17", "21:00", "CSKA Sofia", "FC Thun"),
    (6, "2026-12-17", "21:00", "SC Braga", "Egnatia Rrogozhinë"),
    (6, "2026-12-17", "21:00", "Universitatea Craiova", "FC Copenhagen"),
]
...
LEAGUE_PHASE_DATED_SCHEDULE: dict[str, list[dict]] = {
    ...
    "Europa League": [
        {"matchday": md, "date": d, "time": t, "home": h, "away": a}
        for md, d, t, h, a in _EL_DATED_SCHEDULE_RAW
    ],
    "Conference League": [
        {"matchday": md, "date": d, "time": t, "home": h, "away": a}
        for md, d, t, h, a in _ECL_DATED_SCHEDULE_RAW
    ],
}
